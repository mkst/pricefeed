...
def process_market_data_snapshot(message):
    ...
    for i in range(int(message.getField(268))):
        ...
        provider = fix_md_entry.getField(106)           # Issuer
...
def process_mass_quote(message, active_subscriptions):
    res = []
    ...
    for i in range(int(message.getField(296))):
        ...
        quote_set_id = quote_set.getField(302)
