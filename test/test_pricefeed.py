...
class TestPriceFeedFunctions(unittest.TestCase):
    ...
    def test_process_quote_set_bid_ask(self):
        ...
        quote_set.addGroup(quote_entry)
        res = pf.process_quote_set(quote_set, pxm44.MassQuote.NoQuoteSets.NoQuoteEntries())
        self.assertEqual([['QuoteEntryID', 100.0, 200.0, 1.23, 2.34, None, 'issuer']], res)
    ...
    def test_process_mass_quote_with_quote_id(self):
        subs = { '0': 'EURUSD'}
        quotes = [['0', 1000000.0, 1000000.0, 1.51218, 1.51223, None, '1']]
    ...
    def test_process_mass_quote_multiple_quotesets(self):
        ...
        expected = [
            (1447100433240000, 'EURUSD', [['0', 1000000.0, 1000000.0, 1.51218, 1.51223, None, '1']], False),
            (1447100433240000, 'AUDCAD', [['0', 2000000.0, 2000000.0, 2.51218, 2.51223, None, '2']], False)
        ]
    ...
    def test_process_mass_quote_large_quotesets(self):
        ...
        quotes = [
            (1615906730329000, 'USDHKD', [
                ['0', 1000000.0, 1000000.0, 7.76648, 7.76668, None, '0'],
                ['1', 3000000.0, 3000000.0, 7.76645, 7.7667, None, '0'],
                ['2', 5000000.0, 5000000.0, 7.76643, 7.76673, None, '0'],
                ['3', 10000000.0, 10000000.0, 7.76637, 7.7668, None, '0'],
                ['4', 8000000.0, 8000000.0, 7.76633, 7.76683, None, '2'],
                ['5', 25000000.0, 25000000.0, 7.76618, 7.767, None, '0']
            ], False),
            (1615906730329000, 'USDHUF', [
                ['0', 2800000.0, 3600000.0, 308.355, 308.555, None, '2'],
                ['1', 3100000.0, 3800000.0, 308.354, 308.556, None, '2'],
                ['2', 3300000.0, 3900000.0, 308.353, 308.557, None, '2'],
                ['3', 3600000.0, 4100000.0, 308.352, 308.558, None, '2'],
                ['4', 3900000.0, 6100000.0, 308.351, 308.559, None, '2'],
                ['5', 1000000.0, 1000000.0, 308.29, 308.61, None, '0']
            ], False),
            (1615906730329000, 'USDILS', [
                ['0', 1000000.0, 1000000.0, 3.2997, 3.3016, None, '0'],
                ['1', 2000000.0, 2000000.0, 3.2996, 3.3017, None, '0'],
                ['2', 1000000.0, 3000000.0, 3.2995, 3.3018, None, '0'],
                ['3', 3000000.0, 4000000.0, 3.2994, 3.3019, None, '0'],
                ['4', 4000000.0, 5000000.0, 3.2993, 3.302, None, '0'],
                ['5', 5000000.0, 1000000.0, 3.2992, 3.3021, None, '1']
            ], False),
            (1615906730329000, 'USDJPY', [
                ['0', 4000000.0, 4000000.0, 108.899, 108.901, None, '2'],
                ['1', 3000000.0, 1000000.0, 108.898, 108.901, None, '1'],
                ['2', 1000000.0, 3000000.0, 108.898, 108.902, None, '1'],
                ['3', 5000000.0, 5000000.0, 108.897, 108.903, None, '1'],
                ['4', 5000000.0, 5000000.0, 108.896, 108.903, None, '2'],
                ['5', 1000000.0, 10000000.0, 108.896, 108.904, None, '1']
            ], False),
            (1615906730329000, 'USDMXN', [
                ['0', 1000000.0, 300000.0, 20.5538, 20.55849, None, '2'],
                ['1', 1000000.0, 750000.0, 20.5535, 20.55857, None, '2'],
                ['2', 300000.0, 1500000.0, 20.55349, 20.5588, None, '2'],
                ['3', 750000.0, 2250000.0, 20.55343, 20.55902, None, '2'],
                ['4', 1500000.0, 3000000.0, 20.55326, 20.55921, None, '2'],
                ['5', 2000000.0, 1000000.0, 20.5532, 20.5593, None, '1']
            ], False),
            (1615906730329000, 'USDNOK', [
                ['0', 1000000.0, 1000000.0, 8.47478, 8.47578, None, '2'],
                ['1', 1600000.0, 1500000.0, 8.4745, 8.47606, None, '2'],
                ['2', 2000000.0, 2100000.0, 8.47441, 8.47633, None, '2'],
                ['3', 2600000.0, 4100000.0, 8.47429, 8.47668, None, '2'],
                ['4', 2900000.0, 4600000.0, 8.47424, 8.47672, None, '2'],
                ['5', 2000000.0, 1000000.0, 8.4736, 8.477, None, '0']
            ], False),
            (1615906730329000, 'USDPLN', [
                ['0', 600000.0, 600000.0, 3.8563, 3.8568, None, '2'],
                ['1', 1200000.0, 1100000.0, 3.85619, 3.85689, None, '2'],
                ['2', 1700000.0, 1700000.0, 3.85615, 3.85693, None, '2'],
                ['3', 3700000.0, 2300000.0, 3.85608, 3.85698, None, '2'],
                ['4', 4300000.0, 2900000.0, 3.85607, 3.85702, None, '2'],
                ['5', 1000000.0, 1000000.0, 3.8559, 3.8575, None, '0']
            ], False),
            (1615906730329000, 'USDRUB', [
                ['0', 1000000.0, 1000000.0, 72.689, 72.7084, None, '1'],
                ['1', 1000000.0, 3000000.0, 72.6848, 72.7119, None, '1'],
                ['2', 3000000.0, 1000000.0, 72.6813, 72.715, None, '2'],
                ['3', 5000000.0, 5000000.0, 72.6712, 72.719, None, '1'],
                ['4', 6000000.0, 6000000.0, 72.6672, 72.7229, None, '1']
            ], False),
            (1615906730329000, 'USDSEK', [
                ['0', 1000000.0, 1000000.0, 8.522, 8.5232, None, '2'],
                ['1', 3000000.0, 1500000.0, 8.5218, 8.52335, None, '2'],
                ['2', 1000000.0, 1600000.0, 8.5217, 8.52337, None, '2'],
                ['3', 1600000.0, 2100000.0, 8.52158, 8.52345, None, '2'],
                ['4', 2600000.0, 1000000.0, 8.5215, 8.5235, None, '1'],
                ['5', 3100000.0, 4600000.0, 8.52147, 8.52367, None, '2']
            ], False)
        ]
