    ...
    def test_on_mass_quote_large_quotesets(self):
        ...
        calls = [
            call((1615906730329000, 'USDHKD', [
                ['0', 1000000.0, 1000000.0, 7.76648, 7.76668, '0'],
                ['1', 3000000.0, 3000000.0, 7.76645, 7.7667, '0'],
                ['2', 5000000.0, 5000000.0, 7.76643, 7.76673, '0'],
            ...
            call((1615906730329000, 'USDHUF', [
                ...
                ['2', 3300000.0, 3900000.0, 308.353, 308.557, '2'],
            ...
            call((1615906730329000, 'USDILS', [
                ...
                ['2', 1000000.0, 3000000.0, 3.2995, 3.3018, '0'],
            ...
            call((1615906730329000, 'USDJPY', [
                ...
                ['2', 1000000.0, 3000000.0, 108.898, 108.902, '1'],
            ...
            call((1615906730329000, 'USDMXN', [
                ...
                ['2', 300000.0, 1500000.0, 20.55349, 20.5588, '2'],
            ...
            call((1615906730329000, 'USDNOK', [
                ...
                ['2', 2000000.0, 2100000.0, 8.47441, 8.47633, '2'],
            ...
            call((1615906730329000, 'USDPLN', [
                ...
                ['2', 1700000.0, 1700000.0, 3.85615, 3.85693, '2'],
            ...
            call((1615906730329000, 'USDSEK', [
                ...
                ['2', 1000000.0, 1600000.0, 8.5217, 8.52337, '2'],
